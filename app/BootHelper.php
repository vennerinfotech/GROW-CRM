...
if (!function_exists('middlewareBootSettings')) {
    ...
    function middlewareBootSettings()
    {
        ...
        // cronjob path
        $settings['cronjob_path'] = '/usr/local/bin/php ' . BASE_DIR . '/artisan schedule:run >> /dev/null 2>&1';
...
if (!function_exists('middlewareBootMail')) {
    /**
     * [STANDALONE]
...
if (!function_exists('middlewareSaaSBootMail')) {
    /**
     * [SAAS]
...
if (!function_exists('middlewareBootTheme')) {
    /**
     * [STANDALONE] & [SAAS]
     * Bootstrap the application services.
     *
