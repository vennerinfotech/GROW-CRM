...
/** --------------------------------------------------------------------------------
 * Event fired when category create page is being rendered
...
class CategoryCreate {
     ...
     * This event is fired before the category create page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (page, etc.)
     * @return void
     */
