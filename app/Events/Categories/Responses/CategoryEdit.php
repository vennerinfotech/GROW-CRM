...
/** --------------------------------------------------------------------------------
 * Event fired when category edit page is being rendered
...
class CategoryEdit {
     ...
     * This event is fired before the category edit page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (page, category, categories, etc.)
     * @return void
     */
