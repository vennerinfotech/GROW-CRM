...
/** --------------------------------------------------------------------------------
 * Event fired when category team management page is being rendered
...
class CategoryShowTeam {
     ...
     * This event is fired before the category team management page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (users, etc.)
     * @return void
     */
