...
/** --------------------------------------------------------------------------------
 * Event fired when client index page is being rendered
...
class ClientIndex {
     ...
     * This event is fired before the client index page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (clients, stats, categories, tags, fields, etc.)
     * @return void
     */
