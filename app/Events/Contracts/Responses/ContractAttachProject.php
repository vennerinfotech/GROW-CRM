...
/** --------------------------------------------------------------------------------
 * Event fired when contract attach project page is being rendered
...
class ContractAttachProject {
     ...
     * This event is fired before the contract attach project page is rendered,
