...
/** --------------------------------------------------------------------------------
 * Event fired when contract create page is being rendered
...
class ContractCreate {
     ...
     * This event is fired before the contract create page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (categories, templates, etc.)
     * @return void
     */
