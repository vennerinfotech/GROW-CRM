...
/** --------------------------------------------------------------------------------
 * Event fired when contract index page is being rendered
...
class ContractIndex {
     ...
     * This event is fired before the contract index page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (contracts, stats, categories, etc.)
     * @return void
     */
