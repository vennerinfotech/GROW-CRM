...
/** --------------------------------------------------------------------------------
 * Event fired when contract team signing page is being rendered
...
class ContractSignTeam {
     ...
     * This event is fired before the contract team signing page is rendered,
