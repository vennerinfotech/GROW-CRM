...
/** --------------------------------------------------------------------------------
 * Event fired after saving estimate changes, before response
 * Allows modules to perform actions after estimate has been saved
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class EstimateSaved {
     ...
     * This event is fired after saving changes, before response
     *
