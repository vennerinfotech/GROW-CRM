...
/** --------------------------------------------------------------------------------
 * Event fired after estimate update, before response
 * Allows modules to save their custom data after the estimate has been updated
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class EstimateUpdated {
     ...
     * This event is fired after estimate update, before response
     *
