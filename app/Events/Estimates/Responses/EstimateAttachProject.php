...
/** --------------------------------------------------------------------------------
 * Event fired when estimate attach project page is being rendered
...
class EstimateAttachProject {
     ...
     * This event is fired before the estimate attach project page is rendered,
