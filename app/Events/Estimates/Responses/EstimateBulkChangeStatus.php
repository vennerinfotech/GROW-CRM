...
/** --------------------------------------------------------------------------------
 * Event fired when estimate bulk change status page is being rendered
...
class EstimateBulkChangeStatus {
     ...
     * This event is fired before the estimate bulk change status page is rendered,
