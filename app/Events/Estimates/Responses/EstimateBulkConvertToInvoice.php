...
/** --------------------------------------------------------------------------------
 * Event fired when estimate bulk convert to invoice page is being rendered
...
class EstimateBulkConvertToInvoice {
     ...
     * This event is fired before the estimate bulk convert to invoice page is rendered,
