...
/** --------------------------------------------------------------------------------
 * Event fired when estimate change category page is being rendered
...
class EstimateChangeCategory {
     ...
     * This event is fired before the estimate change category page is rendered,
