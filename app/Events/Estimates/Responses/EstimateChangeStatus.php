...
/** --------------------------------------------------------------------------------
 * Event fired when estimate change status page is being rendered
...
class EstimateChangeStatus {
     ...
     * This event is fired before the estimate change status page is rendered,
