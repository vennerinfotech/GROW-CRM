...
/** --------------------------------------------------------------------------------
 * Event fired when estimate convert to invoice page is being rendered
...
class EstimateConvertToInvoice {
     ...
     * This event is fired before the estimate convert to invoice page is rendered,
