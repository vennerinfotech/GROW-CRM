...
/** --------------------------------------------------------------------------------
 * Event fired when expense change category form is being rendered
...
class ExpenseChangeCategory {
     ...
     * This event is fired before the expense change category form is rendered,
