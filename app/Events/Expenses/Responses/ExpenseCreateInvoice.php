...
/** --------------------------------------------------------------------------------
 * Event fired when expense create invoice form is being rendered
...
class ExpenseCreateInvoice {
     ...
     * This event is fired before the expense create invoice form is rendered,
