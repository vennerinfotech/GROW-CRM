...
/** --------------------------------------------------------------------------------
 * Event fired when expense recurring settings form is being rendered
...
class ExpenseRecurringSettings {
     ...
     * This event is fired before the expense recurring settings form is rendered,
