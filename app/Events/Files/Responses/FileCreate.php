...
/** --------------------------------------------------------------------------------
 * Event fired when file create page is being rendered
...
class FileCreate {
     ...
     * This event is fired before the file create page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (tags, resource type, etc.)
     * @return void
     */
