...
/** --------------------------------------------------------------------------------
 * Event fired when file edit tags page is being rendered
...
class FileEditTags {
     ...
     * This event is fired before the file edit tags page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (file tags, available tags, etc.)
     * @return void
     */
