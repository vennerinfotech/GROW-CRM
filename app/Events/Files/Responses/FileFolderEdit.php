...
/** --------------------------------------------------------------------------------
 * Event fired when file folder edit page is being rendered
...
class FileFolderEdit {
     ...
     * This event is fired before the file folder edit page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (folders, etc.)
     * @return void
     */
