...
/** --------------------------------------------------------------------------------
 * Event fired when file folders page is being rendered
...
class FileFolderShow {
     ...
     * This event is fired before the file folders page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (folders list, etc.)
     * @return void
     */
