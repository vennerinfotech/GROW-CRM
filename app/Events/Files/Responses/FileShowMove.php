...
/** --------------------------------------------------------------------------------
 * Event fired when file move page is being rendered
...
class FileShowMove {
     ...
     * This event is fired before the file move page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (folders, files, etc.)
     * @return void
     */
