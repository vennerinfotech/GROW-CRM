...
/** --------------------------------------------------------------------------------
 * Event fired when home index page is being rendered
...
class HomeIndex {
     ...
     * This event is fired before the home index page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (dashboard data, stats, events, projects, etc.)
     * @return void
     */
