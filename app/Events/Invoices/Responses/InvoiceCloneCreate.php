...
/** --------------------------------------------------------------------------------
 * Event fired when invoice clone form is being rendered
...
class InvoiceCloneCreate {
     ...
     * This event is fired before the invoice clone form is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (invoice, tags, categories, etc.)
     * @return void
     */
