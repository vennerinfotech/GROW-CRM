...
/** --------------------------------------------------------------------------------
 * Event fired when invoice edit modal is being rendered
...
class InvoiceEdit {
     ...
     * This event is fired before the invoice edit modal is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (invoice, categories, tags, etc.)
     * @return void
     */
