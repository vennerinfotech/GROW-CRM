...
/** --------------------------------------------------------------------------------
 * Event fired when invoice index page is being rendered
...
class InvoiceIndex {
     ...
     * This event is fired before the invoice index page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (invoices, stats, categories, tags, projects, etc.)
     * @return void
     */
