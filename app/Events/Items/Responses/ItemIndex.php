...
/** --------------------------------------------------------------------------------
 * Event fired when item index page is being rendered
...
class ItemIndex {
     ...
     * This event is fired before the item index page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (items, categories, stats, etc.)
     * @return void
     */
