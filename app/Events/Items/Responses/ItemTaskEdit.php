...
/** --------------------------------------------------------------------------------
 * Event fired when item task edit page is being rendered
...
class ItemTaskEdit {
     ...
     * This event is fired before the item task edit page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (task, item, users, dependencies, etc.)
     * @return void
     */
