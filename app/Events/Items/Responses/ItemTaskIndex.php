...
/** --------------------------------------------------------------------------------
 * Event fired when item task index page is being rendered
...
class ItemTaskIndex {
     ...
     * This event is fired before the item task index page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (tasks, item, etc.)
     * @return void
     */
