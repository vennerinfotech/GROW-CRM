...
/** --------------------------------------------------------------------------------
 * Event fired after status update(s), before response
 * Allows modules to extend the status change process
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class LeadStatusChanged {
     ...
     * This event is fired after status update(s), before response
     *
