...
/** --------------------------------------------------------------------------------
 * Event fired when lead bulk change status form is being rendered
...
class LeadBulkChangeStatus {
     ...
     * This event is fired before the lead bulk change status form is rendered,
