...
/** --------------------------------------------------------------------------------
 * Event fired when lead create my notes form is being rendered
...
class LeadCreateMyNotes {
     ...
     * This event is fired before the lead create my notes form is rendered,
