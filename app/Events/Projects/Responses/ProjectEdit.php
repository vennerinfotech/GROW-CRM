...
/** --------------------------------------------------------------------------------
 * Event fired when project edit form is being rendered
...
class ProjectEdit {
     ...
     * This event is fired before the project edit form is rendered,
     * allowing modules to modify the payload data and inject form fields
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the form data array (project, categories, fields, etc.)
     * @return void
     */
