...
/** --------------------------------------------------------------------------------
 * Event fired when proposal create page is being rendered
...
class ProposalCreate {
     ...
     * This event is fired before the proposal create page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (categories, templates, clients, etc.)
     * @return void
     */
