...
/** --------------------------------------------------------------------------------
 * Event fired when proposal edit page is being rendered
...
class ProposalEdit {
     ...
     * This event is fired before the proposal edit page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (proposal, categories, custom fields, etc.)
     * @return void
     */
