...
/** --------------------------------------------------------------------------------
 * Event fired when proposal index page is being rendered
...
class ProposalIndex {
     ...
     * This event is fired before the proposal index page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (proposals, stats, filters, etc.)
     * @return void
     */
