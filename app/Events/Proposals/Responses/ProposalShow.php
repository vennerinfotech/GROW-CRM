...
/** --------------------------------------------------------------------------------
 * Event fired when proposal show page is being rendered
...
class ProposalShow {
     ...
     * This event is fired before the proposal show page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (proposal details, estimate, custom fields, etc.)
     * @return void
     */
