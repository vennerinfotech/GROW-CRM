...
/** --------------------------------------------------------------------------------
 * Event fired when proposal sign page is being rendered
...
class ProposalSign {
     ...
     * This event is fired before the proposal sign page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (proposal details, signature form data, etc.)
     * @return void
     */
