...
/** --------------------------------------------------------------------------------
 * Event fired when ticket edit form is being rendered
...
class TicketEdit {
     ...
     * This event is fired before the ticket edit form is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (ticket, categories, projects, statuses, custom fields, etc.)
     * @return void
     */
