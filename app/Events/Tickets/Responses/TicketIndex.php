...
/** --------------------------------------------------------------------------------
 * Event fired when ticket index page is being rendered
...
class TicketIndex {
     ...
     * This event is fired before the ticket index page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (tickets, stats, categories, tags, projects, etc.)
     * @return void
     */
