...
/** --------------------------------------------------------------------------------
 * Event fired when ticket detail page is being rendered
...
class TicketShow {
     ...
     * This event is fired before the ticket detail page is rendered,
     * allowing modules to modify the payload data and inject blade stacks
     *
     * @param  \Illuminate\Http\Request  $request  HTTP request object
     * @param  array  $payload  Reference to the page data array (ticket, replies, attachments, canned responses, etc.)
     * @return void
     */
