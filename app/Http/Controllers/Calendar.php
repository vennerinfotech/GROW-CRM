...
class Calendar extends Controller {
    ...
    public function index() {
        ...
        if (request('calendar_action') == 'user-preferences') {
            ...
            //fire preferences updated event
            event(new \App\Events\Calendar\CalendarPreferencesUpdated(request()));
        }
    ...
    public function store(StoreUpdate $request) {
        ...
        //fire storing event
        event(new \App\Events\Calendar\CalendarStoring(request()));
        ...
        //fire stored event
        event(new \App\Events\Calendar\CalendarStored(request(), $new_event->calendar_event_uniqueid, $payload));
    ...
    public function update(StoreUpdate $request, $id) {
        ...
        //fire updating event
        event(new \App\Events\Calendar\CalendarUpdating(request(), $id));
        ...
        //fire updated event
        event(new \App\Events\Calendar\CalendarUpdated(request(), $id, $payload));
    ...
    public function destroy(DestroyRepository $destroyrepo, $id) {
        ...
        //fire deleting event
        event(new \App\Events\Calendar\CalendarDeleting(request(), $id));
        ...
        //fire deleted event
        event(new \App\Events\Calendar\CalendarDeleted(request(), $id, $payload));
    ...
    public function deleteFiles(ProjectPermissions $projectpermissions, TaskPermissions $taskpermissions, DestroyRepository $destroyrepo, $id) {
        ...
        event(new \App\Events\Calendar\CalendarFileDeleting(request(), $id));
        ...
        event(new \App\Events\Calendar\CalendarFileDeleted(request(), $id, $payload));
