...
class Categories extends Controller {
    ...
    public function store() {
        ...
        //fire storing event
        event(new \App\Events\Categories\CategoryStoring(request()));
        ...
        //fire stored event
        event(new \App\Events\Categories\CategoryStored(request(), $category_id, $payload));
    ...
    public function update(ProjectRepository $projectrepo, $id) {
        ...
        //fire updating event
        event(new \App\Events\Categories\CategoryUpdating(request(), $id));
        ...
        //fire updated event
        event(new \App\Events\Categories\CategoryUpdated(request(), $id, $payload));
    ...
    public function destroy($id) {
        ...
        //fire deleting event
        event(new \App\Events\Categories\CategoryDeleting(request(), $id));
        ...
        //fire deleted event
        event(new \App\Events\Categories\CategoryDeleted(request(), $id, $payload));
    ...
    public function showTeam($id) {
        ...
        //fire event
        event(new \App\Events\Categories\Responses\CategoryShowTeam(request(), $payload));
    ...
    public function updateTeam(ProjectRepository $projectrepo, $id) {
        ...
        event(new \App\Events\Categories\CategoryTeamUpdated(request(), $id, $payload));
