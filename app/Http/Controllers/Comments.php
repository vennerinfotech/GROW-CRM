...
class Comments extends Controller {
    ...
    public function store() {
        ...
        //fire event
        event(new \App\Events\Comment\CommentStoring(request()));
        ...
        //fire event
        event(new \App\Events\Comment\CommentStored(request(), $comment_id, $payload));
    ...
    public function destroy(DestroyRepository $destroyrepo, $id) {
        ...
        //fire event
        event(new \App\Events\Comment\CommentDeleting(request(), $id));
        ...
        //fire event
        event(new \App\Events\Comment\CommentDeleted(request(), $id, $payload));
