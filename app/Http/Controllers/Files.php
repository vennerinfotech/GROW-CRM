...
use App\Http\Responses\Files\EditResponse;
...
class Files extends Controller {
    ...
    public function externalRequest() {
        ...
        //fire event
        event(new \App\Events\Files\FileExternalRequestProcessed(request()));
    }
    ...
    public function store() {
        ...
        //fire event
        event(new \App\Events\Files\FileStoring(request()));
        ...
        //fire event
        $file_ids = $files->pluck('file_id')->toArray();
        event(new \App\Events\Files\FileStored(request(), $file_ids, $payload));
    ...
    public function renameFile($id) {
        ...
        //fire event
        event(new \App\Events\Files\FileRenamed(request(), $id, $payload));
    ...
    public function showImage() {
        ...
        //fire event
        if (request()->filled('file_id')) {
            event(new \App\Events\Files\FileImageServed(request(), request('file_id')));
        }
    ...
    public function download() {
        ...
        //fire event
        event(new \App\Events\Files\FileDownloaded(request(), request('file_id')));
    ...
    public function downloadAttachment() {
        ...
        //fire event
        event(new \App\Events\Files\AttachmentDownloaded(request(), request('attachment_id')));
    ...
    public function update($id) {
        ...
        //fire event
        event(new \App\Events\Files\FileUpdated(request(), $id));
    ...
    public function destroy(DestroyRepository $destroyrepo) {
        ...
        //fire event
        event(new \App\Events\Files\FileDeleting(request(), $allrows));
        ...
        //fire event
        event(new \App\Events\Files\FileDeleted(request(), $allrows, $payload));
    ...
    public function storeFolder() {
        ...
        //fire event
        event(new \App\Events\Files\FileFolderStoring(request()));
        ...
        //fire event
        event(new \App\Events\Files\FileFolderStored(request(), $folder->filefolder_id, $payload));
    ...
    public function updateFolders() {
        ...
        //fire event
        event(new \App\Events\Files\FileFolderUpdated(request(), $filefolder_ids, $payload));
    ...
    public function deleteFolder($id) {
        ...
        //fire event
        event(new \App\Events\Files\FileFolderDeleting(request(), $id));
        ...
        //fire event
        event(new \App\Events\Files\FileFolderDeleted(request(), $id, $payload));
    ...
    public function moveFiles() {
        ...
        //fire event
        event(new \App\Events\Files\FileMoved(request(), $files, $payload));
    ...
    public function bulkDownload() {
        ...
        //fire event
        event(new \App\Events\Files\FileBulkDownloaded(request(), $file_ids, $payload));
    ...
    public function copyAction(ProjectRepository $projectrepo) {
        ...
        //fire event
        event(new \App\Events\Files\FileCopying(request(), $source_file_ids));
        ...
        //fire event
        event(new \App\Events\Files\FileCopied(request(), $source_file_ids, $new_file_ids, $payload));
    ...
    public function updateTags($id) {
        ...
        //fire event
        event(new \App\Events\Files\FileTagsUpdated(request(), $id, $payload));
