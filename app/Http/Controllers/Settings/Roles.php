...
class Roles extends Controller
{
    ...
    public function store(ModuleRolesRespository $modulerepo)
    {
        ...
        $validator = Validator::make(request()->all(), [
            ...
            'role_refunds_dashboard' => 'required',
            'role_refunds_initial' => 'required',
            'role_refunds_authorized' => 'required',
            'role_refunds_completed' => 'required',
            'role_refunds_rejected' => 'required',
