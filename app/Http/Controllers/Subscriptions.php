...
use App\Http\Responses\Subscriptions\EditResponse;
...
use App\Http\Responses\Subscriptions\UpdateResponse;
...
class Subscriptions extends Controller {
    ...
    public function getProductPrices() {
        ...
        event(new \App\Events\Subscriptions\SubscriptionProductPricesRetrieved(request()));
    ...
    public function store(SubscriptionValidation $request) {
        ...
        //fire storing event
        event(new \App\Events\Subscriptions\SubscriptionStoring(request()));
        ...
        //fire stored event
        event(new \App\Events\Subscriptions\SubscriptionStored(request(), $subscription_id, $payload));
    ...
    public function setupStripePayment($id) {
        ...
        //fire setting event
        event(new \App\Events\Subscriptions\SubscriptionStripePaymentSetting(request(), $id));
        ...
        //fire setup event
        event(new \App\Events\Subscriptions\SubscriptionStripePaymentSetup(request(), $id, $payload));
    ...
    public function update($id) {
        ...
        //fire updating event
        event(new \App\Events\Subscriptions\SubscriptionUpdating(request(), $id));
        ...
        //fire updated event
        event(new \App\Events\Subscriptions\SubscriptionUpdated(request(), $id, $payload));
    ...
    public function destroy(DestroyRepository $destroyrepo, $id) {
        ...
        //fire deleting event
        event(new \App\Events\Subscriptions\SubscriptionDeleting(request(), $id));
        ...
        //fire deleted event
        event(new \App\Events\Subscriptions\SubscriptionDeleted(request(), $id, $payload));
    ...
    public function cancelSubscription($id) {
        ...
        //fire cancelling event
        event(new \App\Events\Subscriptions\SubscriptionCancelling(request(), $id));
        ...
        event(new \App\Events\Subscriptions\SubscriptionCancelled(request(), $id, $payload));
    ...
    public function togglePinning(PinnedRepository $pinrepo, $id) {
        ...
        event(new \App\Events\Subscriptions\SubscriptionPinToggled(request(), $id, $payload));
