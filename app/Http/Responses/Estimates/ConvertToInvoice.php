...
class ConvertToInvoice implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //fire event for single or bulk convert to invoice
        if (isset($estimate_id) && $estimate_id > 0) {
            event(new \App\Events\Estimates\Responses\EstimateConvertToInvoice($request, $this->payload));
        } else {
            event(new \App\Events\Estimates\Responses\EstimateBulkConvertToInvoice($request, $this->payload));
        }
