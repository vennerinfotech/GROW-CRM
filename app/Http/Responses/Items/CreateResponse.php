...
class CreateResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        event(new \App\Events\Items\Responses\ItemCreate($this->payload));
        ...
        //render the form
        $html = view('pages/items/components/modals/add-edit-inc', compact('page', 'categories', 'units', 'taxrates', 'custom_fields'))->render();
