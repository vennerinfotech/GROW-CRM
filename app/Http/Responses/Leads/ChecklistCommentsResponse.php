...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [store/destroy checklist comment] process for the leads
 * controller
 * @package   Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class ChecklistCommentsResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if ($response == 'store') {
            ...
            $html = view('pages.lead.components.checklist-comment', compact('comment'))->render();
