...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [attach] process for the proposals
 * controller
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class AttachProjectResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //fire event
        event(new \App\Events\Proposals\Responses\ProposalAttachProject($request, $this->payload));
        ...
        //render the form
        if ($type == 'form') {
            $html = view('pages/proposals/components/actions/attach-project', compact('payload'))->render();
