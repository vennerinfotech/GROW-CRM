...
use App\Events\Tasks\Responses\TaskShow;
...
class ShowResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        // RIGHT PANEL---
        event(new TaskShow($request, $payload, 'pages/task/rightpanel'));
        ...
        event(new TaskShow($request, $payload, 'pages/task/leftpanel'));
        ...
        event(new TaskShow($request, $payload, 'pages/task/components/comment'));
        ...
        event(new TaskShow($request, $payload, 'pages/task/components/checklist'));
        ...
        event(new TaskShow($request, $payload, 'pages/task/components/attachment'));
