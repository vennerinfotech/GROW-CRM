...
class Client extends Model {
    ...
    /**
     * relatioship business rules:
     *         - the Client has one Owner (User)
     *         - the Owner belongs to one Client
     *         - Owner is a User where account_owner = 'yes'
     */
    public function owner() {
        return $this->hasOne('App\Models\User', 'clientid', 'client_id')
