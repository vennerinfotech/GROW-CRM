...
class CloneContractRepository
{
    ...
    public function clone($data = [])
    {
        ...
        $new_contract->contract_automation_status = 'disabled';
        $new_contract->contract_automation_project_title = '';
        $new_contract->contract_automation_project_status = 'in_progress';;
        $new_contract->contract_automation_create_tasks = 'no';
        $new_contract->contract_automation_project_email_client = 'no';
        $new_contract->contract_automation_create_invoice = 'no';
        $new_contract->contract_automation_invoice_due_date = 7;
        $new_contract->contract_automation_invoice_email_client = 'no';
        $new_contract->contract_automation_log_created_project_id = null;
        $new_contract->contract_automation_log_created_invoice_id = null;
