<head>
    ...
    <link rel="stylesheet"
        href="vendor/fonts/phosphor-icons/regular/style.css?v={{ config('system.versioning') }}">

    <!--2025 - TABLER ICONS-->
    <link rel="stylesheet"
        href="vendor/fonts/tabler-icons/tabler-icons.css?v={{ config('system.versioning') }}">

    <!--2025 - LINEICONS ICONS-->
    <link rel="stylesheet" href="vendor/fonts/lineicons/css/icons.css?v={{ config('system.versioning') }}">
