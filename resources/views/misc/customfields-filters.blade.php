        ...
        <div class="row">
            <div class="col-md-12">
                <input type="text" class="form-control form-control-sm"
                    ...
                    value="{{ config('filter.saved_data.filter_' . $field->customfields_name) ?? '' }}">
            </div>
        </div>
    </div>
    @endif
        ...
        <div class="row">
            <div class="col-md-12">
                <input type="text" class="form-control form-control-sm pickadate"
                    ...
                    value="{{ runtimeDatepickerDate(config('filter.saved_data.filter_' . $field->customfields_name) ?? '') }}">
        ...
        <div class="row">
            <div class="col-md-12">
                <select class="select2-basic-with-search form-control form-control-sm select2-preselected" data-allow-clear="true"
                    id="filter_{{ $field->customfields_name }}" name="filter_{{ $field->customfields_name }}"
                    data-preselected="{{ config('filter.saved_data.filter_' . $field->customfields_name) ?? '' }}">
                    <option value=""></option>
        ...
        <div class="row">
            <div class="col-md-12">
                <input type="checkbox" id="filter_{{ $field->customfields_name }}" name="filter_{{ $field->customfields_name }}"
                    ...
                    {{ runtimePrechecked(config('filter.saved_data.filter_' . $field->customfields_name) ?? '') }}>
