...
<div class="hidden" id="invoice-logic">
    ...
    <!--invoice subtotal before line discounts (inline mode only)-->
    <label class="col-12 text-left control-label col-form-label">bill_subtotal_before_discount</label>
    <input type="number" class="decimal-field" name="bill_subtotal_before_discount" id="bill_subtotal_before_discount"
        value="{{ $bill->bill_subtotal_before_discount ?? 0 }}">
