        ...
        <div class="modal-content">
                ...
                <div class="clearfix">
                    <div class="header-search pull-right" id="header-search-items">
                        ...
                        <input type="text" class="form-control search-records list-actions-search"
                            ...
                            data-type="form" data-ajax-type="post" data-form-id="header-search-items" id="search_query"
                            name="search_query" placeholder="{{ cleanLang(__('lang.search')) }}">
                    </div>
                </div>
            ...
            <div class="modal-footer p-t-0 p-b-20 invoice-billing-footer" id="itemsModalFooter">
                <a id="itemsModalSelectButton" href="javascript:void(0);"
                    class="btn btn-rounded-x btn-danger waves-effect text-left hidden" data-url=""
                    data-loading-target="" data-ajax-type="POST"
                    data-on-start-submit-button="disable">{{ cleanLang(__('lang.add_selected_items')) }}</a>
            </div>
        </div>
    </div>
</div>
