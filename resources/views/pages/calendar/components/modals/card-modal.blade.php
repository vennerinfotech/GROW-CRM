    ...
    <div class="modal-dialog" id="cardModalContainer">
        <div class="modal-content hidden" id="cardModalContent">
            ...
            <div class="modal-body row min-h-200" id="cardModalBody">
                ...
                <!--LEAD/TASK PANELS UNION-->
                <!--Lead Left Panel-->
                <div class="col-sm-12 col-lg-8 card-left-panel" id="card-leads-left-panel"></div>
                <!--Task Left Panel-->
                <div class="col-sm-12 col-lg-8 card-left-panel" id="card-left-panel"></div>

                <!--Lead Right Panel-->
                <div class="col-sm-12 col-lg-4 card-right-panel" id="card--leads-right-panel"></div>
                <!--Task Right Panel-->
                <div class="col-sm-12 col-lg-4 card-right-panel" id="card-right-panel"></div>

            </div>
            <!--convert to customer (Lead specific)-->
...
<!--js dom elements (using leads as it is a superset/identical)-->
