...
<div class="row" id="js-trigger-clients-modal-add-edit" data-payload="{{ $page['section'] ?? '' }}">
    <div class="col-lg-12">
        ...
        <!--invoice due days-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">@lang('lang.invoice_due_days')
                <span class="align-middle text-info font-16" data-toggle="tooltip" title="@lang('lang.invoice_due_days_info')"
                    data-placement="top"><i class="ti-info-alt"></i></span></label>
            <div class="col-sm-12 col-lg-9">
                <input type="number" class="form-control form-control-sm" id="client_billing_invoice_due_days"
                    name="client_billing_invoice_due_days" value="{{ $client->client_billing_invoice_due_days ?? '' }}"
                    min="0">
            </div>
        </div>
        <div class="line"></div>
        ...
        <div id="client_app_modules_collaped" class="hidden">
            ...
            <div id="client_app_modules_pemissions"
                ...
                <div class="highlighted-panel">
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_projects"
                                ...
                                {{ runtimePrechecked($client->client_settings_modules_projects ?? '') }}
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_invoices"
                                ...
                                {{ runtimePrechecked($client->client_settings_modules_invoices ?? '') }}
                                {{  $creation_prechecked }} class="filled-in chk-col-light-blue">
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_payments"
                                ...
                                {{ runtimePrechecked($client->client_settings_modules_payments ?? '') }}
                                {{  $creation_prechecked }} class="filled-in chk-col-light-blue">
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_knowledgebase"
                                ...
                                {{ runtimePrechecked($client->client_settings_modules_knowledgebase ?? '') }}
                                {{  $creation_prechecked }} class="filled-in chk-col-light-blue">
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_estimates"
                                ...
                                {{ runtimePrechecked($client->client_settings_modules_estimates ?? '') }}
                                {{  $creation_prechecked }} class="filled-in chk-col-light-blue">
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_subscriptions"
                                ...
                                {{ runtimePrechecked($client->client_settings_modules_subscriptions ?? '') }}
                                {{  $creation_prechecked }} class="filled-in chk-col-light-blue">
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_tickets"
                                ...
                                {{ runtimePrechecked($client->client_settings_modules_tickets ?? '') }}
                                {{  $creation_prechecked }} class="filled-in chk-col-light-blue">
                    ...
                    <div class="alert alert-info">@lang('lang.only_system_enabled_modules_enabled') <a
                            href="{{ url('app/settings/modules') }}" target="_blank">(@lang('lang.see_settings'))</a>
                    </div>
                </div>
