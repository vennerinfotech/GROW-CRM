        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <span class="list-table-action dropdown font-size-inherit">
                ...
                <div class="dropdown-menu" aria-labelledby="listTableAction">
                    ...
                    @if($contact->account_owner == 'no')
                    <a title="@lang('lang.set_as_account_owner')" href="javascript:void(0);"
                        class="dropdown-item confirm-action-info"
                        data-confirm-title="@lang('lang.confirm_set_account_owner')"
                        data-confirm-text="@lang('lang.confirm_set_account_owner_text')"
                        data-url="{{ url('contacts/'.$contact->id.'/update-account-owner') }}"
                        data-ajax-type="POST">
                        @lang('lang.set_as_account_owner')
                    </a>
                    @endif
                </div>
            </span>
