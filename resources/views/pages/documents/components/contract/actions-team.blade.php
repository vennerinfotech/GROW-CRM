        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item click-to-copy-url" href="javascript:void(0);"
                    data-url="{{ url('contracts/view/'.$document->doc_unique_id) }}">
                    @lang('lang.contract_url')
                    <i class="ti-clipboard float-right"></i>
                </a>
                ...
                <a href="javascript:void(0)"
                    ...
                    data-action-method="PUT" data-action-ajax-loading-target="commonModalBody">@lang('lang.automation')
                </a>
