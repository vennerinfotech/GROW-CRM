            ...
            <div class="r-panel-body p-l-35 p-r-35">
                        ...
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[item_description]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30" for="standard_field[item_description]">@lang('lang.name')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[item_notes]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30" for="standard_field[item_notes]">@lang('lang.description')</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="custom_field[item_custom_field_{{ $customField->items_custom_id }}]"
                                    name="custom_field[item_custom_field_{{ $customField->items_custom_id }}]"
                                    class="filled-in chk-col-light-blue">
                                <label class="p-l-30" for="custom_field[item_custom_field_{{ $customField->items_custom_id }}]">{{ $customField->items_custom_field_name }}</label>
                            </div>
                        </div>
                    </div>
                    @endforeach
