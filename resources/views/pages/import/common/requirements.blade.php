<div class="importing-requirements">
    ...
    <div class="splash-image">
        <img src="{{ url('/') }}/images/system-checks.png" alt="404 - Not found" />
    </div>
    ...
    @if (config('system.settings_type') == 'standalone')
        ...
        <div class="splash-sub-text m-t-30">
            <a href="https://crm.grow.jovial-noether.94-136-184-62.plesk.page/importing-introduction/" target="_blank"
