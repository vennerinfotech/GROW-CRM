...
@if($type == 'items')
<div class="x-splash-failed-text">
    <a href="{{ url('storage/system/samples/import-items.csv') }}" download>@lang('lang.csv_sample')</a>
    | <a href="{{ url('storage/system/samples/import-items.xlsx') }}" download>@lang('lang.xlsx_sample')</a>
</div>
@endif
