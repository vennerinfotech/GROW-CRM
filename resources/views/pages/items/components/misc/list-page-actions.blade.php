...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" title="{{ cleanLang(__('lang.import_items')) }}" id="items-import-button"
            ...
            data-action-url="{{ url('import/items') }}" data-action-method="POST"
            data-loading-target="commonModalBody" data-action-ajax-loading-target="commonModalBody"
            data-modal-title="@lang('lang.import_items')" data-url="{{ url('import/items/create') }}">
            <i class="ti-import"></i>
        </button>
        @endif
