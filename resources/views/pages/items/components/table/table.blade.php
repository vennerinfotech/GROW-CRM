            ...
            <div class="filtered-results-warning opacity-8 p-b-5">
                <small>
                    ...
                    <a href="javascript:void(0);" class="js-toggle-side-panel"
                        data-target="sidepanel-filter-items">@lang('lang.filtered')</a>.
                    @lang('lang.you_can')
                ...
                <table id="items-list-table" class="table m-t-0 m-b-0 table-hover no-wrap item-list" data-page-size="10">
                    <thead>
                        <tr>
                            ...
                            <th
                                class="items_col_tableconfig_column_1 {{ config('table.tableconfig_column_1') }} tableconfig_column_1">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_item_description"
                            ...
                            <th
                                class="items_col_tableconfig_column_2 {{ config('table.tableconfig_column_2') }} tableconfig_column_2">
                            ...
                            <th
                                class="items_col_tableconfig_column_3 {{ config('table.tableconfig_column_3') }} tableconfig_column_3">
                            ...
                            <th
                                class="items_col_tableconfig_column_4 {{ config('table.tableconfig_column_4') }} tableconfig_column_4">
                            ...
                            <th
                                class="items_col_tableconfig_column_5 {{ config('table.tableconfig_column_5') }} tableconfig_column_5">
                                @if (request('itemresource_type') == 'lead')
                                    <a class="js-ajax-ux-request js-list-sorting" id="sort_count_sold"
                                        href="javascript:void(0)"
                                        data-url="{{ urlResource('/items?action=sort&orderby=count_sold&sortorder=asc') }}">@lang('lang.quantity')<span
                                            class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                                @else
                                    <a class="js-ajax-ux-request js-list-sorting" id="sort_count_sold"
                                        href="javascript:void(0)"
                            ...
                            <th
                                class="items_col_tableconfig_column_7 {{ config('table.tableconfig_column_7') }} tableconfig_column_7">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_item_notes"
                                    href="javascript:void(0)"
                            ...
                            <th
                                class="items_col_tableconfig_column_8 {{ config('table.tableconfig_column_8') }} tableconfig_column_8">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_item_tax_status"
                                    href="javascript:void(0)"
                            ...
                            <th
                                class="items_col_tableconfig_column_9 {{ config('table.tableconfig_column_9') }} tableconfig_column_9">
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 1)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_10 {{ config('table.tableconfig_column_10') }} tableconfig_column_10">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 1)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 2)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_11 {{ config('table.tableconfig_column_11') }} tableconfig_column_11">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 2)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 3)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_12 {{ config('table.tableconfig_column_12') }} tableconfig_column_12">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 3)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 4)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_13 {{ config('table.tableconfig_column_13') }} tableconfig_column_13">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 4)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 5)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_14 {{ config('table.tableconfig_column_14') }} tableconfig_column_14">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 5)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 6)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_15 {{ config('table.tableconfig_column_15') }} tableconfig_column_15">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 6)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 7)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_16 {{ config('table.tableconfig_column_16') }} tableconfig_column_16">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 7)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 8)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_17 {{ config('table.tableconfig_column_17') }} tableconfig_column_17">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 8)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 9)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_18 {{ config('table.tableconfig_column_18') }} tableconfig_column_18">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 9)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif
                            ...
                            @if (\App\Models\ProductCustomField::where('items_custom_id', 10)->where('items_custom_field_status', 'enabled')->exists())
                                <th
                                    class="items_col_tableconfig_column_19 {{ config('table.tableconfig_column_19') }} tableconfig_column_19">
                                    <a
                                        href="javascript:void(0)">{{ \App\Models\ProductCustomField::where('items_custom_id', 10)->first()->items_custom_field_name }}</a>
                                </th>
                            @endif

                            @if (config('visibility.items_col_action'))
                                <th class="items_col_action with-table-config-icon actions_column"><a
