    ...
    <div class="x-section">
        ...
        <div class="x-element text-center font-14" id="card-lead-element-container-name">
            ...
            <span class="x-highlight x-editable js-card-settings-button-static" id="card-lead-name" data-container=".card-modal" tabindex="0"
                ...
                <span id="card-lead-firstname-containter" class="card-lead-firstname-containter">{{ $lead->lead_firstname }}</span> <span
                    id="card-lead-lastname-containter" class="card-lead-lastname-containter">{{ $lead->lead_lastname }}</span></span>
                @else
                    <span id="card-lead-firstname-containter">@lang('lang.add_contact')</span> <span
                    id="card-lead-lastname-containter"></span></span>
                @endif
            @else
