            ...
            @if ($lead->permission_edit_lead)
                <span class="x-highlight x-editable js-card-settings-button-static" id="card-lead-name"
                    ...
                    @if ($lead->lead_firstname || $lead->lead_lastname)
                        <span id="card-lead-firstname-containter"
                            class="card-lead-firstname-containter">{{ $lead->lead_firstname }}</span> <span
                            id="card-lead-lastname-containter"
                            class="card-lead-lastname-containter">{{ $lead->lead_lastname }}</span>
                </span>
            @else
