        ...
        <div class="x-footer row">
            <div class="col-6 x-icons">
                ...
                <span title="{{ cleanLang(__('lang.star_lead')) }}"
                    class="x-icon vm p-t-2 data-toggle-action-tooltip opacity-4 font-14 ajax-request {{ $lead->is_starred ? 'hidden' : '' }} starred-star-button-{{ $lead->lead_id }}"
                    id="starred-star-button-{{ $lead->lead_id }}" data-stop-propagation="yes"
                ...
                <span title="{{ cleanLang(__('lang.unstar_lead')) }}"
                    class="x-icon vm p-t-2 data-toggle-action-tooltip font-14 ajax-request text-warning {{ !$lead->is_starred ? 'hidden' : '' }} starred-unstar-button-{{ $lead->lead_id }}"
                    id="starred-unstar-button-{{ $lead->lead_id }}" data-stop-propagation="yes"
