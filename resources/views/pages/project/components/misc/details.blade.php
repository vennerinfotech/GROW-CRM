...
<div class="card" id="project_details" data-progress="{{ $project->project_progress }}">
    ...
    @stack('section_project_details_top')
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <!--module integration point-->
        @stack('section_project_details_client')
    ...
    <div class="card-body p-t-0 p-b-0">
        <div class="row">
            ...
            <!--module integration point-->
            @stack('section_project_details_dates')
        </div>
    </div>
    <div class="m-t-10 m-b-10">
        <hr>
    ...
    <div class="card-body p-t-0 p-b-0">
        <div class="row">
            ...
            <!--module integration point-->
            @stack('section_project_details_billing')
        </div>
    </div>
    @endif
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <!--module integration point-->
        @stack('section_project_details_invoices')
    </div>
    @endif

    <!--module integration point-->
    @stack('section_project_details_main')
    ...
    <!--module integration point-->
    @stack('section_project_details_end')
