...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" title="{{ cleanLang(__('lang.import_projects')) }}" id="projects-import-button"
            ...
            data-action-url="{{ url('import/projects') }}" data-action-method="POST"
            data-loading-target="commonModalBody" data-action-ajax-loading-target="commonModalBody"
            data-modal-title="@lang('lang.import_projects')" data-url="{{ url('import/projects/create') }}">
            <i class="ti-import"></i>
        </button>
        @endif
