...
@section('settings-page')
    ...
    <form class="form" id="settingsFormEmailGeneral">
        ...
        <div class="alert alert-danger">{{ cleanLang(__('lang.cronjob_and_emails')) }}. <a
                href="https://crm.grow.jovial-noether.94-136-184-62.plesk.page/cron-job-settings/"
        ...
        <div class="text-right">
            ...
            <button type="submit" id="email-general-settings-button"
                class="btn btn-rounded-x btn-danger waves-effect text-left" data-url="/settings/email/general"
