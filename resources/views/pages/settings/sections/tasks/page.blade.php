...
@section('settings-page')
    ...
    <form class="form">
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-4 col-form-label">{{ cleanLang(__('lang.pending_checklist_items')) }}</label>
            <div class="col-8 p-t-5">
                <input type="checkbox" id="settings_tasks_kanban_pending_checklists"
                    name="settings_tasks_kanban_pending_checklists" class="filled-in chk-col-light-blue"
                    {{ runtimePrechecked($settings['settings_tasks_kanban_pending_checklists'] ?? '') }}>
                <label for="settings_tasks_kanban_pending_checklists"></label>
            </div>
        </div>
