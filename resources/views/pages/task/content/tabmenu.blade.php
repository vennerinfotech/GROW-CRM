...
<ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item"> <a class="nav-link ajax-request" data-toggle="tab" href="javascript:void(0);" role="tab"
                        ...
                        <span class="sl-icon-refresh font-13 vm text-danger p-l-5 {{ runtimeTaskRecurringIcon($task->task_recurring) }}"
                                id="task-modal-menu-recurring-icon" data-toggle="tooltip"
