...
@stack('section_task_right_panel_one')
...
<!--module extension point - allows modules to inject content-->
@stack('section_task_right_panel_two')
...
<!--module extension point - allows modules to inject content-->
@stack('section_task_right_panel_tree')
...
<div class="x-section">
    ...
    <div class="x-element" id="card-task-priority"><i class="mdi mdi-flag"></i>
        ...
        @if($task->permission_edit_task)
        <span class="x-highlight x-editable js-card-settings-button-static" data-container=".card-modal"
            id="card-task-priority-text" tabindex="0" data-popover-content="card-task-priorities" data-offset="0 25%"
            data-status-id="{{ $task->taskpriority_id }}"
...
<!--module extension point - allows modules to inject content-->
@stack('section_task_right_panel_four')
...
<!--module extension point - allows modules to inject content-->
@stack('section_task_right_panel_five')
...
<!--module extension point - allows modules to inject content-->
@stack('action_task_dependencies')

<!--module extension point - allows modules to inject content-->
@stack('section_task_right_panel_six')
...
<div class="x-section">
    ...
    <div class="x-element x-action js-card-settings-button-static" data-container=".card-modal" id="card-task-milestone"
        tabindex="0" data-popover-content="card-task-milestones" data-title="{{ cleanLang(__('lang.milestone')) }}"><i
...
<!--module extension point - allows modules to inject content-->
@stack('section_task_right_panel_seven')
    ...
    <div class="x-element x-action">
        <table class="table table-bordered table-sm">
            <tbody>
                ...
                @stack('section_task_right_panel_information_table_row')
...
<!--module extension point - allows modules to inject content-->
@stack('section_task_right_panel_eight')
...
<div class="hidden" id="card-task-statuses">
    <ul class="list">
        ...
        <li class="card-tasks-update-status-link" data-button-text="card-task-status-text" data-progress-bar='hidden'
            data-url="{{ urlResource('/tasks/'.$task->task_id.'/update-status') }}" data-type="form"
            data-value="{{ $task_status->taskstatus_id }}" data-form-id="--set-dynamically--" data-ajax-type="post">
