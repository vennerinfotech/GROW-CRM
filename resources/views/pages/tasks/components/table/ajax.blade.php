    ...
    <td class="tasks_col_action actions_column">
        ...
        <span class="list-table-action">
            <button type="button" title="{{ cleanLang(__('lang.star_task')) }}"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm opacity-4 ajax-request {{ $task->is_starred ? 'hidden' : '' }} starred-star-button-{{ $task->task_id }}"
        ...
        <span class="list-table-action">
            <button type="button" title="{{ cleanLang(__('lang.unstar_task')) }}"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm ajax-request text-warning {{ !$task->is_starred ? 'hidden' : '' }} starred-unstar-button-{{ $task->task_id }}"
