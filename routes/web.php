...
Route::group(['prefix' => 'leads'], function () {
    ...
    Route::post('/{lead}/add-checklist-items', 'Leads@storeChecklistItems')->where('lead', '[0-9]+');
...
Route::group(['prefix' => 'settings/occasions'], function () {
    Route::get('/', 'Settings\Occasions@index');
    Route::get('/create', 'Settings\Occasions@create');
    Route::post('/', 'Settings\Occasions@store');
...
Route::group(['prefix' => 'templates/projects'], function () {
    ...
    Route::any('/{project}/{section}', 'Templates\Projects@showDynamic')
        ->where(['project' => '-[0-9]+', 'section' => 'details|files|tasks|milestones'])
